...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['Country']) && isset($_POST['Name']) && isset($_POST['Zone'])) {
    $query_update = "UPDATE city SET Country=:Country, Name=:Name, Zone=:Zone WHERE id=:id";
...
if (isset($_GET['delete'])) {
    $id = $_GET['delete'];
    $query_delete = "DELETE FROM city WHERE id = :id";
